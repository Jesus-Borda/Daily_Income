...
import 'widget/cardRegistrationDay.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Cards(
                  ...
                  title: Text("Meta Cumplida", style: TextStyle(fontSize: 14, color: Colors.white)),
                  txCentral: Text("\$1500",
                  style: TextStyle(
                      fontSize: 30,
                      fontWeight: FontWeight.bold,
                ...
                Cards(
                  ...
                  title: Text("Promedio Diario", style: TextStyle(fontSize: 14, color: const Color.fromARGB(255, 0, 0, 0))),
                  txCentral: Text("\$200",
                  style: TextStyle(
                      fontSize: 30,
                      fontWeight: FontWeight.bold,
